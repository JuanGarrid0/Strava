...
public class Client {
    ...
    public Client(String email, Date birthdate, double weight, int height, double maxHearRate, double normalHeartRate,
        ...
        // Esto no es seguro en aplicaciones multihilo o distribuidas.
        // El contador se reiniciará si reinicias el servidor (si no usas persistencia).
